...
/**
 * The twenty-seven creatures of the realm. Twelve natives, twelve walked in
 * from the world's mythologies, and an ecology wing of three — a low-flier,
 * a swimmer, and a burrower. Every species is a full organism now: its
