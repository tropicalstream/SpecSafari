...
/**
 * The beam: streams this phone's GPS to the TapHunter glasses app over
 ...
 * is TapHunter's own — Everyday's channel is untouched and both can run.
 *
...
class LocationBeamService : Service() {
    ...
    companion object {
        ...
        private const val SERVICE_NAME = "TapHunterBeam"
        private const val TAG = "TapHunterBeam"
    ...
    private fun notification(): Notification {
        ...
        return builder
            .setContentTitle("TapHunter beam")
