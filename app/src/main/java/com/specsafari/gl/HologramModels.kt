    ...
    fun forSpecies(i: Int): FloatArray {
        ...
        when (i) {
            ...
            26 -> { // MOLDEWARP
                ...
                b.sphere(0f, 0.1f, 0.55f, sp.main)
                for (i in 0 until 22) {
                    val a = (i / 22f) * (Math.PI * 2).toFloat()
                    b.seg(0f, -0.1f, 0.55f,
                        cos(a) * 0.28f, -0.1f + sin(a) * 0.28f, 0.72f, sp.accent)
                }
                b.eyes(sp.accent)
            }
            27 -> { // SYLVARCH — branching glade intelligence
                b.sphere(0f, 0f, 0.45f, sp.main)
                b.sphere(0f, 0.34f, 0.32f, sp.main)
                for (sx in intArrayOf(-1, 1)) {
                    b.seg(sx * 0.22f, -0.1f, 0.22f, sx * 0.34f, -0.72f, 0.28f, sp.accent)
                    b.seg(sx * 0.2f, -0.12f, -0.22f, sx * 0.32f, -0.72f, -0.30f, sp.main)
                    b.seg(sx * 0.11f, 0.52f, 0.25f, sx * 0.28f, 1.02f, 0.20f, sp.accent)
                    b.seg(sx * 0.24f, 0.84f, 0.22f, sx * 0.56f, 1.12f, 0.20f, sp.accent)
                    b.seg(sx * 0.22f, 0.82f, 0.22f, sx * 0.10f, 1.12f, 0.18f, sp.accent)
                    b.seg(sx * 0.08f, 0f, -0.38f, sx * 0.58f, 0.36f, -0.92f, sp.accent)
                }
                b.seg(0f, 0f, -0.40f, 0f, 0.58f, -1.02f, sp.main)
                b.eyes(sp.accent)
            }
            28 -> { // MISTCROWN — six-limbed canopy cartographer
                b.sphere(0f, 0.10f, 0.48f, sp.main)
                b.sphere(0f, 0.43f, 0.32f, sp.main)
                for (pair in 0..2) for (sx in intArrayOf(-1, 1)) {
                    val z = 0.27f - pair * 0.27f
                    b.seg(sx * 0.18f, 0f, z, sx * (0.58f + pair * 0.05f), -0.48f, z, sp.accent)
                    b.ring(sx * (0.58f + pair * 0.05f), -0.48f, z,
                        0.12f, 0.12f, Builder.XZ, sp.accent, 6)
                }
                b.seg(0f, 0.05f, -0.4f, 0.36f, 0.16f, -0.92f, sp.main)
                b.seg(0.36f, 0.16f, -0.92f, 0.08f, 0.42f, -1.10f, sp.accent)
                for (k in 0 until 7) {
                    val a = (k / 7f) * (Math.PI * 2).toFloat()
                    b.seg(0f, 0.67f, 0.27f,
                        cos(a) * 0.34f, 1.02f + sin(a * 2f) * 0.08f,
                        0.27f + sin(a) * 0.24f, sp.accent)
                }
                b.eyes(sp.accent)
            }
            else -> error("No hologram morphology for species index $i")
        }
